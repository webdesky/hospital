                            ...
                            <form role="form" method="post" action="<?php echo base_url('admin/addAppointment') ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span>
                                        <?php echo form_error('appointment_type'); ?></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span>
                                        <?php echo form_error('patient_id'); ?></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="wide" name="hospital_id" id="hospital_id" onchange="get_doctor(this.value)">
                                            ...
                                            <option value="<?php echo $value->id; ?>" <?php echo set_select( 'hospital_id', $value->id); ?>>
                                                <?php echo ucwords($value->hospital_name); ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                        <span>
                                        <?php echo form_error('hospital_id'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span>
                                        <?php echo form_error('doctor_id'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span>
                                        <?php echo form_error('appointment_date'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span>
                                        <?php echo form_error('problem'); ?></span>
                                    </div>
                                </div>
